...
def get_file(html_str,href,file_ad):
    ...
    for each in file_infos:
        ...
        if re.findall('http',file_href):
            ...
            newfile_href = 'http://www.most.gov.cn/' + file_href
...
#国务院政策    静态网页
def gwyzc_url(row,worksheet,url,href_bloom,file_ad,ProgramStarttime):
    source1 = '国务院'
    source2 = '政策'
    source3 = '政策法规'
...
def main(row,worksheet,href_bloom,file_ad1,ProgramStarttime):
    href_list = []
    url1 = 'http://sousuo.gov.cn/column/30469/0.htm'
    row,chref_list = gwyzc_url(row,worksheet,url1,href_bloom,file_ad1,ProgramStarttime)
